namespace FOLHA_DE_PAGAMENTO_
{
    partial class FormHolerite
    {
        ...
        private void InitializeComponent()
        {
            ...
            label4 = new Label();
            TxtIDHolerite = new Label();
            label42 = new Label();
            TxtFgtsMes = new Label();
            TxtBaseirrf = new Label();
            TxtBaseFgts = new Label();
            TxtBaseinss = new Label();
            TxtSalarioBase = new Label();
            label56 = new Label();
            label55 = new Label();
            label54 = new Label();
            label53 = new Label();
            ...
            panel14 = new Panel();
            label19 = new Label();
            panelValorLiquido = new Panel();
            label57 = new Label();
            TxtValorLiquido = new Label();
            panelDescTotal = new Panel();
            label51 = new Label();
            TxtDescTotal = new Label();
            panelVencTotal = new Panel();
            label48 = new Label();
            TxtVencTotal = new Label();
            panelDescontos = new Panel();
            DescIRRF = new Label();
            DescINSS = new Label();
            label30 = new Label();
            label27 = new Label();
            ...
            label36 = new Label();
            label35 = new Label();
            panelVencimentos = new Panel();
            ValorFGTS = new Label();
            VencIRRF = new Label();
            VencINSS = new Label();
            TxtSalarioBaseMensal = new Label();
            label23 = new Label();
            label40 = new Label();
            label38 = new Label();
            label34 = new Label();
            ...
            panelValorLiquido.SuspendLayout();
            panelDescTotal.SuspendLayout();
            panelVencTotal.SuspendLayout();
            panelDescontos.SuspendLayout();
            panelVencimentos.SuspendLayout();
            panelReferencia.SuspendLayout();
            panelDescricao.SuspendLayout();
            panelCod.SuspendLayout();
            ...
            LbHolerite.Controls.Add(BtnHome);
            LbHolerite.Controls.Add(BtnPrint);
            ...
            BtnHome.Location = new Point(1004, 39);
            ...
            BtnPrint.Location = new Point(1004, 578);
            ...
            label2.Location = new Point(514, 109);
            label2.Name = "label2";
            ...
            CbAno.Location = new Point(645, 104);
            CbAno.Name = "CbAno";
            ...
            label47.Location = new Point(788, 110);
            ...
            CbMes.Location = new Point(923, 105);
            CbMes.Name = "CbMes";
            ...
            PanelHolerite.Controls.Add(panel18);
            PanelHolerite.Controls.Add(panel17);
            PanelHolerite.Controls.Add(panel15);
            PanelHolerite.Controls.Add(panel16);
            PanelHolerite.Controls.Add(panel10);
            PanelHolerite.Controls.Add(panel14);
            PanelHolerite.Controls.Add(panelValorLiquido);
            PanelHolerite.Controls.Add(panelDescTotal);
            PanelHolerite.Controls.Add(panelVencTotal);
            PanelHolerite.Controls.Add(panelDescontos);
            PanelHolerite.Controls.Add(panelVencimentos);
            PanelHolerite.Controls.Add(panelReferencia);
            PanelHolerite.Controls.Add(panelDescricao);
            PanelHolerite.Controls.Add(panelCod);
            PanelHolerite.Controls.Add(panel4);
            PanelHolerite.Controls.Add(panel3);
            PanelHolerite.Controls.Add(panel2);
            PanelHolerite.Controls.Add(panel1);
            PanelHolerite.Location = new Point(67, 142);
            ...
            panel19.Controls.Add(TxtIDHolerite);
            ...
            panel19.Controls.Add(TxtBaseinss);
            panel19.Controls.Add(TxtSalarioBase);
            ...
            panel19.Location = new Point(3, 466);
            ...
            label46.Location = new Point(655, 25);
            ...
            label45.Location = new Point(505, 25);
            ...
            label44.Location = new Point(365, 25);
            ...
            label43.Location = new Point(225, 25);
            ...
            label17.Location = new Point(95, 25);
            ...
            label4.Location = new Point(785, 5);
            label4.Name = "label4";
            ...
            // TxtIDHolerite
            // 
            TxtIDHolerite.AutoSize = true;
            TxtIDHolerite.Location = new Point(8, 25);
            TxtIDHolerite.Name = "TxtIDHolerite";
            TxtIDHolerite.Size = new Size(51, 15);
            TxtIDHolerite.TabIndex = 92;
            TxtIDHolerite.Text = "Numero";
            // 
            // label42
            // 
            ...
            // TxtFgtsMes
            // 
            TxtFgtsMes.AutoSize = true;
            TxtFgtsMes.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            TxtFgtsMes.Location = new Point(525, 25);
            ...
            // TxtBaseirrf
            // 
            TxtBaseirrf.AutoSize = true;
            TxtBaseirrf.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            TxtBaseirrf.Location = new Point(676, 25);
            ...
            // TxtBaseFgts
            // 
            TxtBaseFgts.AutoSize = true;
            TxtBaseFgts.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            TxtBaseFgts.Location = new Point(388, 25);
            ...
            // TxtBaseinss
            // 
            TxtBaseinss.AutoSize = true;
            TxtBaseinss.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            TxtBaseinss.Location = new Point(247, 25);
            ...
            TxtSalarioBase.Location = new Point(117, 25);
            ...
            label56.Font = new Font("Segoe UI", 10F, FontStyle.Bold, GraphicsUnit.Point);
            label56.Location = new Point(655, 5);
            label56.Name = "label56";
            label56.Size = new Size(94, 19);
            label56.TabIndex = 85;
            label56.Text = "Base de IRRF";
            // 
            // label55
            // 
            label55.AutoSize = true;
            label55.Font = new Font("Segoe UI", 10F, FontStyle.Bold, GraphicsUnit.Point);
            label55.Location = new Point(505, 5);
            label55.Name = "label55";
            label55.Size = new Size(95, 19);
            label55.TabIndex = 84;
            label55.Text = "FGTS do mês";
            // 
            // label54
            // 
            label54.AutoSize = true;
            label54.Font = new Font("Segoe UI", 10F, FontStyle.Bold, GraphicsUnit.Point);
            label54.Location = new Point(365, 5);
            label54.Name = "label54";
            label54.Size = new Size(98, 19);
            label54.TabIndex = 83;
            label54.Text = "Base de FGTS";
            // 
            // label53
            // 
            label53.AutoSize = true;
            label53.Font = new Font("Segoe UI", 10F, FontStyle.Bold, GraphicsUnit.Point);
            label53.Location = new Point(225, 5);
            label53.Name = "label53";
            label53.Size = new Size(96, 19);
            label53.TabIndex = 82;
            label53.Text = "Base de INSS";
            // 
            // label52
            // 
            label52.AutoSize = true;
            label52.Font = new Font("Segoe UI", 10F, FontStyle.Bold, GraphicsUnit.Point);
            label52.Location = new Point(95, 5);
            label52.Name = "label52";
            label52.Size = new Size(91, 19);
            label52.TabIndex = 81;
            label52.Text = "Salário Base";
            // 
            // panel18
            // 
            panel18.BorderStyle = BorderStyle.FixedSingle;
            panel18.Controls.Add(label11);
            panel18.Location = new Point(849, 175);
            ...
            label5.TabIndex = 9;
            label5.Text = "Vencimentos";
            // 
            // panel15
            // 
            panel15.BorderStyle = BorderStyle.FixedSingle;
            panel15.Controls.Add(label13);
            panel15.Location = new Point(3, 175);
            ...
            panel16.Location = new Point(636, 175);
            ...
            label6.TabIndex = 10;
            label6.Text = "Referência";
            // 
            // panel10
            // 
            panel10.BorderStyle = BorderStyle.FixedSingle;
            panel10.Controls.Add(label12);
            panel10.Location = new Point(74, 175);
            ...
            panel14.Location = new Point(636, 420);
            ...
            label19.TabIndex = 11;
            label19.Text = "Valor Liquido : ";
            // 
            // panelValorLiquido
            // 
            panelValorLiquido.BorderStyle = BorderStyle.FixedSingle;
            panelValorLiquido.Controls.Add(label57);
            panelValorLiquido.Controls.Add(TxtValorLiquido);
            ...
            label57.ForeColor = Color.FromArgb(0, 70, 0);
            label57.Location = new Point(5, 10);
            ...
            // TxtValorLiquido
            // 
            TxtValorLiquido.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            TxtValorLiquido.AutoSize = true;
            TxtValorLiquido.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            TxtValorLiquido.ForeColor = Color.FromArgb(0, 70, 0);
            TxtValorLiquido.Location = new Point(27, 10);
            TxtValorLiquido.MaximumSize = new Size(88, 19);
            TxtValorLiquido.Name = "TxtValorLiquido";
            TxtValorLiquido.Size = new Size(60, 19);
            TxtValorLiquido.TabIndex = 73;
            TxtValorLiquido.Text = "2082,89";
            // 
            // panelDescTotal
            // 
            panelDescTotal.BorderStyle = BorderStyle.FixedSingle;
            panelDescTotal.Controls.Add(label51);
            panelDescTotal.Controls.Add(TxtDescTotal);
            ...
            label51.ForeColor = Color.FromArgb(170, 0, 0);
            label51.Location = new Point(5, 9);
            label51.Name = "label51";
            label51.Size = new Size(25, 19);
            label51.TabIndex = 99;
            label51.Text = "R$";
            // 
            // TxtDescTotal
            // 
            TxtDescTotal.Anchor = AnchorStyles.Left;
            TxtDescTotal.AutoSize = true;
            TxtDescTotal.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            TxtDescTotal.ForeColor = Color.FromArgb(170, 0, 0);
            TxtDescTotal.Location = new Point(25, 9);
            TxtDescTotal.MaximumSize = new Size(88, 19);
            TxtDescTotal.Name = "TxtDescTotal";
            TxtDescTotal.Size = new Size(60, 19);
            TxtDescTotal.TabIndex = 73;
            TxtDescTotal.Text = "1200,47";
            // 
            // panelVencTotal
            // 
            panelVencTotal.BorderStyle = BorderStyle.FixedSingle;
            panelVencTotal.Controls.Add(label48);
            panelVencTotal.Controls.Add(TxtVencTotal);
            ...
            label48.ForeColor = Color.FromArgb(0, 70, 0);
            label48.Location = new Point(5, 9);
            ...
            // TxtVencTotal
            // 
            TxtVencTotal.Anchor = AnchorStyles.Left;
            TxtVencTotal.AutoSize = true;
            TxtVencTotal.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            TxtVencTotal.ForeColor = Color.FromArgb(0, 70, 0);
            TxtVencTotal.Location = new Point(25, 9);
            TxtVencTotal.MaximumSize = new Size(88, 19);
            TxtVencTotal.Name = "TxtVencTotal";
            TxtVencTotal.Size = new Size(60, 19);
            TxtVencTotal.TabIndex = 73;
            TxtVencTotal.Text = "2283,36";
            // 
            // panelDescontos
            // 
            panelDescontos.BorderStyle = BorderStyle.FixedSingle;
            panelDescontos.Controls.Add(DescIRRF);
            panelDescontos.Controls.Add(DescINSS);
            panelDescontos.Controls.Add(label30);
            panelDescontos.Controls.Add(label27);
            panelDescontos.Controls.Add(label37);
            panelDescontos.Controls.Add(label36);
            panelDescontos.Controls.Add(label35);
            panelDescontos.Location = new Point(849, 209);
            ...
            // DescIRRF
            // 
            DescIRRF.AutoSize = true;
            DescIRRF.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            DescIRRF.ForeColor = Color.FromArgb(170, 0, 0);
            DescIRRF.Location = new Point(21, 38);
            DescIRRF.MaximumSize = new Size(88, 19);
            DescIRRF.Name = "DescIRRF";
            DescIRRF.Size = new Size(57, 19);
            DescIRRF.TabIndex = 77;
            DescIRRF.Text = "000000";
            // 
            // DescINSS
            // 
            DescINSS.AutoSize = true;
            DescINSS.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            DescINSS.ForeColor = Color.FromArgb(170, 0, 0);
            DescINSS.Location = new Point(21, 19);
            DescINSS.MaximumSize = new Size(88, 19);
            DescINSS.Name = "DescINSS";
            DescINSS.Size = new Size(57, 19);
            DescINSS.TabIndex = 76;
            ...
            label30.ForeColor = Color.FromArgb(170, 0, 0);
            ...
            label27.MaximumSize = new Size(88, 19);
            label27.Name = "label27";
            label27.Size = new Size(21, 19);
            label27.TabIndex = 74;
            label27.Text = "--";
            // 
            // label37
            ...
            label37.ForeColor = Color.FromArgb(170, 0, 0);
            ...
            label36.ForeColor = Color.FromArgb(170, 0, 0);
            ...
            label35.ForeColor = Color.FromArgb(170, 0, 0);
            ...
            panelVencimentos.Controls.Add(ValorFGTS);
            panelVencimentos.Controls.Add(VencIRRF);
            panelVencimentos.Controls.Add(VencINSS);
            panelVencimentos.Controls.Add(TxtSalarioBaseMensal);
            panelVencimentos.Controls.Add(label23);
            panelVencimentos.Controls.Add(label40);
            panelVencimentos.Controls.Add(label38);
            panelVencimentos.Controls.Add(label34);
            panelVencimentos.Controls.Add(label33);
            panelVencimentos.Location = new Point(733, 209);
            ...
            // ValorFGTS
            // 
            ValorFGTS.AutoSize = true;
            ValorFGTS.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            ValorFGTS.ForeColor = Color.Black;
            ValorFGTS.Location = new Point(21, 57);
            ValorFGTS.MaximumSize = new Size(88, 19);
            ValorFGTS.Name = "ValorFGTS";
            ValorFGTS.Size = new Size(57, 19);
            ValorFGTS.TabIndex = 78;
            ValorFGTS.Text = "000000";
            // 
            // VencIRRF
            // 
            VencIRRF.AutoSize = true;
            VencIRRF.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            VencIRRF.ForeColor = Color.Black;
            VencIRRF.Location = new Point(21, 38);
            VencIRRF.MaximumSize = new Size(88, 19);
            VencIRRF.Name = "VencIRRF";
            VencIRRF.Size = new Size(57, 19);
            VencIRRF.TabIndex = 77;
            VencIRRF.Text = "000000";
            // 
            // VencINSS
            // 
            VencINSS.AutoSize = true;
            VencINSS.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            VencINSS.ForeColor = Color.Black;
            VencINSS.Location = new Point(21, 19);
            VencINSS.MaximumSize = new Size(88, 19);
            VencINSS.Name = "VencINSS";
            VencINSS.Size = new Size(57, 19);
            VencINSS.TabIndex = 76;
            VencINSS.Text = "000000";
            // 
            // TxtSalarioBaseMensal
            // 
            TxtSalarioBaseMensal.AutoSize = true;
            TxtSalarioBaseMensal.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            TxtSalarioBaseMensal.ForeColor = Color.Black;
            TxtSalarioBaseMensal.Location = new Point(21, 0);
            TxtSalarioBaseMensal.MaximumSize = new Size(88, 19);
            TxtSalarioBaseMensal.Name = "TxtSalarioBaseMensal";
            TxtSalarioBaseMensal.Size = new Size(57, 19);
            TxtSalarioBaseMensal.TabIndex = 75;
            TxtSalarioBaseMensal.Text = "000000";
            // 
            // label23
            // 
            ...
            label23.Location = new Point(0, 76);
            label23.MaximumSize = new Size(88, 19);
            label23.Name = "label23";
            label23.Size = new Size(21, 19);
            label23.TabIndex = 74;
            label23.Text = "--";
            // 
            // label40
            ...
            panelReferencia.Controls.Add(label22);
            panelReferencia.Controls.Add(TaxaFGTS);
            panelReferencia.Controls.Add(TaxaIRRF);
            panelReferencia.Controls.Add(TaxaINSS);
            panelReferencia.Controls.Add(label29);
            panelReferencia.Location = new Point(636, 209);
            ...
            label22.Location = new Point(0, 76);
            label22.MaximumSize = new Size(88, 19);
            label22.Name = "label22";
            label22.Size = new Size(21, 19);
            label22.TabIndex = 75;
            label22.Text = "--";
            // 
            // TaxaFGTS
            // 
            TaxaFGTS.AutoSize = true;
            TaxaFGTS.Dock = DockStyle.Top;
            TaxaFGTS.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            TaxaFGTS.Location = new Point(0, 57);
            TaxaFGTS.MaximumSize = new Size(88, 19);
            TaxaFGTS.Name = "TaxaFGTS";
            TaxaFGTS.Size = new Size(21, 19);
            TaxaFGTS.TabIndex = 73;
            TaxaFGTS.Text = "--";
            // 
            // TaxaIRRF
            // 
            TaxaIRRF.AutoSize = true;
            TaxaIRRF.Dock = DockStyle.Top;
            TaxaIRRF.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            ...
            // TaxaINSS
            // 
            TaxaINSS.AutoSize = true;
            TaxaINSS.Dock = DockStyle.Top;
            TaxaINSS.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            ...
            panelDescricao.Controls.Add(label7);
            panelDescricao.Controls.Add(TxtNomeCompleto);
            panelDescricao.Controls.Add(label26);
            panelDescricao.Controls.Add(label25);
            panelDescricao.Controls.Add(label24);
            panelDescricao.Location = new Point(74, 209);
            ...
            label7.Location = new Point(0, 57);
            label7.MaximumSize = new Size(550, 0);
            label7.Name = "label7";
            ...
            TxtNomeCompleto.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            TxtNomeCompleto.Location = new Point(-1, 76);
            ...
            panelCod.Controls.Add(TxtIdFGTS);
            panelCod.Controls.Add(TxtMatricula_);
            panelCod.Controls.Add(TxtIDIRRF);
            panelCod.Controls.Add(TxtIDINSS);
            panelCod.Controls.Add(label21);
            panelCod.Location = new Point(3, 209);
            ...
            // TxtIdFGTS
            // 
            TxtIdFGTS.AutoSize = true;
            TxtIdFGTS.Dock = DockStyle.Top;
            TxtIdFGTS.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            ...
            // TxtMatricula_
            // 
            TxtMatricula_.AutoSize = true;
            TxtMatricula_.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            ...
            // TxtIDIRRF
            // 
            TxtIDIRRF.AutoSize = true;
            TxtIDIRRF.Dock = DockStyle.Top;
            TxtIDIRRF.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            ...
            // TxtIDINSS
            // 
            TxtIDINSS.AutoSize = true;
            TxtIDINSS.Dock = DockStyle.Top;
            TxtIDINSS.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            ...
            label21.MaximumSize = new Size(57, 19);
            label21.Name = "label21";
            label21.Size = new Size(21, 19);
            label21.TabIndex = 17;
            label21.Text = "--";
            // 
            // panel4
            ...
            panel4.Controls.Add(TxtDataAdmissao);
            panel4.Controls.Add(TxtCargo);
            panel4.Controls.Add(TxtNome);
            panel4.Controls.Add(TxtMatricula);
            ...
            TxtCargo.Size = new Size(149, 19);
            TxtCargo.TabIndex = 73;
            TxtCargo.Text = "Auxiliar Almoxarifado II";
            // 
            // TxtNome
            // 
            ...
            label18.Location = new Point(845, 0);
            ...
            label16.Location = new Point(630, 0);
            ...
            label15.Location = new Point(70, 0);
            ...
            label14.TabIndex = 13;
            label14.Text = "Matrícula";
            // 
            // panel3
            // 
            panel3.BorderStyle = BorderStyle.FixedSingle;
            panel3.Controls.Add(TxtDataEmissao);
            panel3.Controls.Add(label50);
            panel3.Controls.Add(label49);
            panel3.Location = new Point(3, 420);
            panel3.Name = "panel3";
            ...
            panel2.Controls.Add(TxtAno);
            panel2.Controls.Add(TxtMes);
            panel2.Controls.Add(label3);
            panel2.Controls.Add(TxtMensal);
            panel2.Location = new Point(686, 3);
            panel2.Name = "panel2";
            ...
            label58.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            label58.Location = new Point(130, 80);
            label58.Name = "label58";
            label58.Size = new Size(24, 19);
            label58.TabIndex = 10;
            label58.Text = "de";
            // 
            // TxtAno
            ...
            label3.TabIndex = 1;
            label3.Text = "Recibo de Pagamento";
            // 
            // TxtMensal
            // 
            TxtMensal.AutoSize = true;
            TxtMensal.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point);
            TxtMensal.Location = new Point(110, 50);
            TxtMensal.Name = "TxtMensal";
            TxtMensal.Size = new Size(53, 19);
            TxtMensal.TabIndex = 7;
            TxtMensal.Text = "Mensal";
            // 
            // panel1
            // 
            ...
            panelValorLiquido.ResumeLayout(false);
            panelValorLiquido.PerformLayout();
            panelDescTotal.ResumeLayout(false);
            panelDescTotal.PerformLayout();
            panelVencTotal.ResumeLayout(false);
            panelVencTotal.PerformLayout();
            panelDescontos.ResumeLayout(false);
            panelDescontos.PerformLayout();
            panelVencimentos.ResumeLayout(false);
            panelVencimentos.PerformLayout();
            panelReferencia.ResumeLayout(false);
            panelReferencia.PerformLayout();
            panelDescricao.ResumeLayout(false);
            panelDescricao.PerformLayout();
            panelCod.ResumeLayout(false);
            panelCod.PerformLayout();
        ...
        internal Label TxtMes;
        internal Label TxtMatricula_;
        internal Label TxtIDIRRF;
        internal Label TxtIDINSS;
        internal Label TxtDataAdmissao;
        internal Label TxtCargo;
        internal Label TxtNome;
        internal Label TxtMatricula;
        internal Label label21;
        internal Label TxtAno;
        internal TextBox TxtPesquisarMatricula;
        internal Label TxtValorLiquido;
        internal Label TxtDescTotal;
        internal Label TxtVencTotal;
        ...
        internal Label TaxaFGTS;
        internal Label TaxaIRRF;
        internal Label TaxaINSS;
        internal Label TxtNomeCompleto;
        internal Label TxtDataEmissao;
        internal ComboBox CbMes;
        internal ComboBox CbAno;
        internal Label TxtIDHolerite;
        internal Label TxtFgtsMes;
        internal Label TxtBaseirrf;
        internal Label TxtBaseFgts;
        internal Label TxtBaseinss;
        internal Label TxtSalarioBase;
        internal Label TxtDataLancamento;
        private Label label7;
        internal Label TxtIdFGTS;
        internal Label label27;
        internal Label ValorFGTS;
        internal Label VencIRRF;
        internal Label VencINSS;
        internal Label TxtSalarioBaseMensal;
        internal Label label23;
        internal Label label22;
        internal Label DescIRRF;
        internal Label DescINSS;
